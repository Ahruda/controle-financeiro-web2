...
create table transactions (titulo varchar(150) not NULL, valor double not NULL, categoria_id int not null, tipo int not null, datacao varchar(20) not null, hora varchar(50) not null, id int NOT NULL AUTO_INCREMENT, PRIMARY KEY (id), FOREIGN KEY (categoria_id) REFERENCES categories(id));
